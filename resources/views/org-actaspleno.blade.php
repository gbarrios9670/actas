        ...
        <tbody>
            @forelse ($datos as $dato)
                <tr>
                    ...
                    <td col width="25px">
                        {{--  @if ($dato->pdf_existe)
                            <a href="{{ URL::route('ver_pdf', $dato->dire_web) }}" class="btn btn-warning btn-sm pull-right" target="_blank"><i class="fa fa-picture-o"></i>Pdf</a>
                        @endif  --}}
                        <a href="{{ URL::route('showAsambleaPdf', [$dato->id, 2]) }}" class="btn btn-warning btn-sm pull-right" target="_blank"><i class="fa fa-picture-o"></i>Pdf</a>
                    </td> 
                </tr>
            @empty
